...
Option.monadError()
// arrow.instances.option.monadError.OptionMonadErrorInstanceKt$monadError$1@45310c40
```
...
Try.monadError()
// arrow.instances.try.monadError.TryMonadErrorInstanceKt$monadError$1@1a3770b6
```
...
// arrow.instances.either.monadError.EitherMonadErrorInstanceKt$monadError$1@26b2b26e
```
