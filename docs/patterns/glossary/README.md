...
```kotlin
String.eq()
// arrow.instances.StringKt$eq$1@9b320f
```

```kotlin
Option.functor()
// arrow.instances.option.functor.OptionFunctorInstanceKt$functor$1@7d1377f7
```
...
// arrow.instances.mapk.semigroup.MapKSemigroupInstanceKt$semigroup$1@58741321
```

```kotlin
Either.monadError<Throwable>()
// arrow.instances.either.monadError.EitherMonadErrorInstanceKt$monadError$1@7781c479
```

```kotlin
ListK.traverse()
// arrow.instances.listk.traverse.ListKTraverseInstanceKt$traverse$2@71c93032
```
...
ListK.functor()
// arrow.instances.listk.functor.ListKFunctorInstanceKt$functor$1@56f6baca
```
